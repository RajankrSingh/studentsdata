    ...
    <AuthGuard requiredUserType="distributor">
      <DistributorLayout>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-gradient-to-br from-cyan-500 via-blue-500 to-indigo-600 rounded-2xl p-8 text-white shadow-2xl hover:shadow-cyan-500/30 transform hover:scale-[1.02] transition-all duration-300 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-6">
                <div>
                  {isLoadingUsers ? (
                    ...
                    <h2 className="text-5xl font-bold mb-2 drop-shadow-lg">{totalUsers.toLocaleString()}</h2>
                  )}
                  <p className="text-cyan-50 text-xl font-semibold">Total Users/Schools</p>
                </div>
              ...
              <button 
                ...
                className="w-full mt-6 bg-white/20 hover:bg-white/30 backdrop-blur-sm text-white font-semibold py-3 px-6 rounded-xl transition-all duration-200 flex items-center justify-center space-x-2 shadow-lg hover:shadow-xl transform hover:scale-105"
              >
                <span>View all</span>
