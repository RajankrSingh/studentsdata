...
export default function AuthGuard({ children, requiredUserType }) {
  ...
  // Don't show logout button if using SchoolLayout (it has its own logout)
  const hideLogoutButton = typeof window !== 'undefined' && window.location.pathname.startsWith('/school')
